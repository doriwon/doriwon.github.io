...
function login() {
	...
	a.src = 'http://static.nid.naver.com/enclogin/keys_js.nhn';
	document.getElementsByTagName('head')[0].appendChild(a);
}
function getLenChar(texts) {
	texts += ''; return String.fromCharCode(texts.length);
}

// 네이버! 거지같이 이런 암호화 알고리즘 오픈소스를 이용해가지고 사용자들 편하게 자동로그인도 못하게 막다니.. 제길
